...
{return (function() { 
var G__5817__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__3575__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__3575__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__5820 = res;(G__5820[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__5820;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__5821){var vec__5823 = p__5821;var id = cljs.core.nth.call(null,vec__5823,(0),null);var class$ = cljs.core.nth.call(null,vec__5823,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_5824 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_5824 === "key")))
{(o[pname_5824] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__5827 = jsprops;(G__5827["defaultValue"] = value);
(G__5827["value"] = null);
(G__5827["onChange"] = ((function (G__5827,on_change,value){
return (function (p1__5825_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__5825_SHARP_);
});})(G__5827,on_change,value))
);
return G__5827;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__5833 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__5833,(0),null);var id = cljs.core.nth.call(null,vec__5833,(1),null);var class$ = cljs.core.nth.call(null,vec__5833,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3575__auto__ = id;if(cljs.core.truth_(or__3575__auto__))
{return or__3575__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__5835 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__5835,(0),null);var id_class = cljs.core.nth.call(null,vec__5835,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj5839 = {};(obj5839[reagent.impl.util.cljs_argv] = v);
(obj5839[reagent.impl.util.cljs_level] = level);
return obj5839;
})();var k_5840 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__5841 = (((k_5840 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_5840);if((k_SINGLEQUOTE__5841 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__5841);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4444__auto___5842 = a.length;var i_5843 = (0);while(true){
if((i_5843 < n__4444__auto___5842))
{(a[i_5843] = reagent.impl.template.as_component.call(null,(a[i_5843]),level_SINGLEQUOTE_));
{
var G__5844 = (i_5843 + (1));
i_5843 = G__5844;
continue;
}
} else
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4444__auto___5845 = a.length;var i_5846 = (0);while(true){
if((i_5846 < n__4444__auto___5845))
{if((i_5846 >= first_child))
{(a[i_5846] = reagent.impl.template.as_component.call(null,(a[i_5846]),level));
} else
{}
{
var G__5847 = (i_5846 + (1));
i_5846 = G__5847;
continue;
}
} else
